...
public final class Settings {
    ...
    /**
     * @hide - Private call() method on SettingsProvider to read from 'cmremix' table.
     */
    public static final String CALL_METHOD_GET_CMREMIX = "GET_cmremix";
    ...
    /** @hide - Private call() method to write to 'cmRemiX' table */
    public static final String CALL_METHOD_PUT_CMREMIX = "PUT_cmremix";
    ...
    /**
     * cmRemiX settings, containing cmRemiX specific preferences.  This
     * table holds simple name/value pairs.  There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class CMREMIX extends NameValueTable {
        public static final String SYS_PROP_SETTING_VERSION = "sys.settings_system_version";
         ...
         */
        public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/cmremix");

        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_SETTING_VERSION,
                CONTENT_URI,
                CALL_METHOD_GET_CMREMIX,
                CALL_METHOD_PUT_CMREMIX);
