...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            mDirectionArrowsEnabled = Settings.CMREMIX.getIntForUser(resolver,
                    Settings.CMREMIX.STATUS_BAR_SHOW_NETWORK_ACTIVITY,
        ...
        public void onChange(boolean selfChange) {
            mDirectionArrowsEnabled = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                    Settings.CMREMIX.STATUS_BAR_SHOW_NETWORK_ACTIVITY,
                    1, UserHandle.USER_CURRENT) == 1 ? true : false;
            refreshViews();
        }
    ...
    void refreshViews() {
        ...
        final String customCarrierLabel = Settings.CMREMIX.getStringForUser(context.getContentResolver(),
