...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    private void updateCameraVisibility() {
        ...
        boolean hideCamera = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.CAMERA_WIDGET_HIDE, 0, UserHandle.USER_CURRENT) == 1;
    ...
    private void updatePhoneVisibility() {
        ...
        boolean hidePhone = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.DIALER_WIDGET_HIDE, 0, UserHandle.USER_CURRENT) == 1;
