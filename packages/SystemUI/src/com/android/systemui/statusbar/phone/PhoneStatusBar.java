...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.HEADS_UP_NOTIFCATION_DECAY),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.HEADS_UP_SNOOZE_TIME),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri.equals(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.HEADS_UP_SNOOZE_TIME))) {
                    final int snoozeTime = Settings.CMREMIX.getIntForUser(
                    ...
                    Settings.CMREMIX.HEADS_UP_NOTIFCATION_DECAY))) {
                    mHeadsUpNotificationDecay = Settings.CMREMIX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.CMREMIX.HEADS_UP_NOTIFCATION_DECAY,
                            mContext.getResources().getInteger(
