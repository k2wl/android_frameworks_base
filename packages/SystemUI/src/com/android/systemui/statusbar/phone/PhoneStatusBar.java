...
import com.android.systemui.aicp.SearchPanelSwipeView;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.BATTERY_SAVER_MODE_COLOR),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.QS_COLOR_SWITCH),
                    false, this, UserHandle.USER_ALL);
            update();
        }
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri.equals(Settings.System.getUriFor(
                    Settings.CMREMIX.BATTERY_SAVER_MODE_COLOR))) {
                    mBatterySaverWarningColor = Settings.CMREMIX.getIntForUser(
                    ...
                    Settings.CMREMIX.QS_COLOR_SWITCH))) {
                    mQSCSwitch = Settings.CMREMIX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.CMREMIX.QS_COLOR_SWITCH,
        ...
        public void update() {
            ...
            mQSCSwitch = Settings.CMREMIX.getIntForUser(resolver,
                    Settings.CMREMIX.QS_COLOR_SWITCH, 0, mCurrentUserId) == 1;
        }
    }
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mCmremixLabel = (TextView)mStatusBarView.findViewById(R.id.cmremix_custom_label);
...
//                    updateCarrierLabelVisibility(false);
        ...
        if ((diff & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) {
            if ((state & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) {
                ...
                if (mGreeting != null && !TextUtils.isEmpty(mGreeting) && mShowLabel) {
                    if (animate) {
                        mCmremixLabel.setVisibility(View.VISIBLE);
                        mCmremixLabel.animate().cancel();
                        mCmremixLabel.animate()
                                .alpha(1f)
    ...
    protected void labelAnimatorFadeOut(final boolean animate) {
        ...
        mCmremixLabel.animate()
            ...
            @Override
            public void run() {
                mCmremixLabel.setVisibility(View.GONE);
                animateStatusBarShow(mNotificationIconArea, animate);
            }
        });
    }
