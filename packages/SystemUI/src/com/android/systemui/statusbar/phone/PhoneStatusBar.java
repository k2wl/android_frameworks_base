    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.BATTERY_SAVER_MODE_COLOR), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        public void update() {
            ...
            mBatterySaverBarColor = Settings.CMREMIX.getInt(
                    resolver, Settings.CMREMIX.BATTERY_SAVER_MODE_COLOR, 1) == 1;
        }
    }
