...
public class PhoneStatusBarPolicy {
    ...
    public PhoneStatusBarPolicy(Context context, CastController cast, SuController su) {
        ...
        mContext.getContentResolver().registerContentObserver(
                Settings.CMREMIX.getUriFor(Settings.CMREMIX.SHOW_BLUETOOTH_ICON),
    ...
    private ContentObserver mBluetoothIconObserver = new ContentObserver(null) {
        @Override
        public void onChange(boolean selfChange, Uri uri) {
            mBluetoothIconVisible = Settings.CMREMIX.getInt(mContext.getContentResolver(),
                    Settings.CMREMIX.SHOW_BLUETOOTH_ICON, 1) == 1;
            updateBluetooth();
        }
