...
public class StatusBarHeaderView extends RelativeLayout implements View.OnClickListener, View.OnLongClickListener,
    ...
    private final QSPanel.Callback mQsPanelCallback = new QSPanel.Callback() {
        ...
        private void handleShowingDetail(final QSTile.DetailAdapter detail) {
            ...
            if (showingDetail) {
                int color = Settings.CMREMIX.getInt(
    ...
    class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.QS_COLOR_SWITCH), false, this,
                    UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            mQSCSwitch = Settings.CMREMIX.getInt(
                    resolver, Settings.CMREMIX.QS_COLOR_SWITCH, 0) == 1;
