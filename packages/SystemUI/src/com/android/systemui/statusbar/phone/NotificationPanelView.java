    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.STATUS_BAR_QUICK_QS_PULLDOWN), false, this);
        ...
        public void update() {
            ContentResolver resolver = mContext.getContentResolver();
            mOneFingerQuickSettingsInterceptMode = Settings.CMREMIX.getIntForUser(
                    resolver, Settings.CMREMIX.STATUS_BAR_QUICK_QS_PULLDOWN,
