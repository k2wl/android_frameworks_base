...
public class QSPanel extends ViewGroup {
    ...
    private void updateDetailText() {
        mQSCSwitch = Settings.CMREMIX.getInt(mContext.getContentResolver(),
                Settings.CMREMIX.QS_COLOR_SWITCH, 0) == 1;
        int textColor = Settings.CMREMIX.getInt(mContext.getContentResolver(),
                    Settings.CMREMIX.QS_TEXT_COLOR, 0xffffffff);
    ...
    public void setDetailBackgroundColor(int color) {
        mQSCSwitch = Settings.CMREMIX.getInt(getContext().getContentResolver(),
                Settings.CMREMIX.QS_COLOR_SWITCH, 0) == 1;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            mContext.getContentResolver(), Settings.System.QUICK_SETTINGS_TILES_VIBRATE,
                0, UserHandle.USER_CURRENT) == 1;
            mQSShadeTransparency = Settings.CMREMIX.getIntForUser(
            mContext.getContentResolver(), Settings.CMREMIX.QS_TRANSPARENT_SHADE,
                0, UserHandle.USER_CURRENT) == 1;
            mQSCSwitch = Settings.CMREMIX.getIntForUser(
            mContext.getContentResolver(), Settings.CMREMIX.QS_COLOR_SWITCH,
                0, UserHandle.USER_CURRENT) == 1;
        }
    }
}
