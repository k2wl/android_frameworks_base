...
public class QSTileView extends ViewGroup {
    ...
    private void recreateLabel() {
        ...
        boolean mQSCSwitch = Settings.CMREMIX.getInt(getContext().getContentResolver(),
    ...
    protected void updateColors() {
        ...
        mQSCSwitch = Settings.CMREMIX.getInt(resolver,
                Settings.CMREMIX.QS_COLOR_SWITCH, 0) == 1;
        if (mQSCSwitch) {
            mLabelColor = Settings.CMREMIX.getInt(resolver,
                    Settings.CMREMIX.QS_TEXT_COLOR, 0xffffffff);
            mIconColor = Settings.CMREMIX.getInt(resolver,
                    Settings.CMREMIX.QS_ICON_COLOR, 0xffffffff);
        }
    }
